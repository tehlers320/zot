...
func (service *BaseService) FetchManifest(ctx context.Context, repo, reference string) (
	...
	// to be downloaded.
	manifestMediaType := manifest.GetMediaType(fetchedManifest)
	if manifestMediaType == manifest.MediaTypeOCI1ManifestList ||
		manifestMediaType == manifest.MediaTypeDocker2ManifestList {
